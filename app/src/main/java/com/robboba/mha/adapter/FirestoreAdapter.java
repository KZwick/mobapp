package com.robboba.mha.adapter;
 ...
 *
 * Adapted by kevin on 2018-04-05.
 */
...
public abstract class FirestoreAdapter<VH extends RecyclerView.ViewHolder>
    ...
    // added code from tutorial onEvent.
    ...
    public void onEvent(QuerySnapshot documentSnapshots,
        ...
        for (DocumentChange change : documentSnapshots.getDocumentChanges()) {
            ...
            switch (change.getType()) {
                case ADDED:
                    // Done: handle document added
                    onDocumentAdded(change);
                    break;
                case MODIFIED:
                    // Done: handle document modified
                    onDocumentModified(change);
                    break;
                case REMOVED:
                    // Done: handle document removed
                    onDocumentRemoved(change);
                    break;
            }
        }
    ...
    // finally added the start listening event.
